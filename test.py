...
logging.basicConfig(
    filename="test_single_gan_20000_loss.log",
...
parser.add_argument('--decoder_path', type=str, default='output2/experiment_20000_single_gan/decoder_iter_160000.pth')
parser.add_argument('--Trans_path', type=str, default='output2/experiment_20000_single_gan/transformer_iter_160000.pth')
parser.add_argument('--embedding_path', type=str, default='output2/experiment_20000_single_gan/embedding_iter_160000.pth')
